...
# Viteビルド用の環境変数を定義（デフォルト値付き）
ARG VITE_API_BASE_URL=/api
ARG VITE_FIREBASE_API_KEY=AIzaSyCjuPCpB0wqHxdX4JWL6VnEj1LJWgr4cKc
ARG VITE_FIREBASE_AUTH_DOMAIN=haibun-distribution.firebaseapp.com
ARG VITE_FIREBASE_PROJECT_ID=haibun-distribution
ARG VITE_FIREBASE_STORAGE_BUCKET=haibun-distribution.firebasestorage.app
ARG VITE_FIREBASE_MESSAGING_SENDER_ID=742220611313
ARG VITE_FIREBASE_APP_ID=1:742220611313:web:bec0f006c4c648adcbb350
